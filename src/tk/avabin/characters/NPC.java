...
public class NPC extends Character {
    public NPC(Origin origin, Profession profession, Specialization specialization, ArrayList<Abillity> abillities,
               ArrayList<Trick> tricks, Inventory inventory, int[] attributes) {
